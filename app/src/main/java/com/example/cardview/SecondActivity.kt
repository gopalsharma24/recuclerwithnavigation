...
class SecondActivity : AppCompatActivity() , BlogListAdapter.OnItemClickListener{
    ...
    override fun onItemClick(position: Int) {
       ...
       Toast.makeText(this, blogPost[position].title, Toast.LENGTH_SHORT).show()
    }
}